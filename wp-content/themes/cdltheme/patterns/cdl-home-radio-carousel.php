<?php
/**
 * Title: Home — Rádio Companhia (carrossel)
 * Slug: cdltheme/cdl-home-radio-carousel
 * Categories: featured, query
 * Keywords: home, carrossel, rádio, spotify, youtube
 * Description: Carrossel do tipo Rádio (company_radio): imagem, título, resumo e links por item; três no desktop, um no mobile.
 *
 * @package cdltheme
 */

$radio_pt     = cdltheme_post_type_company_radio();
$radio_archive = cdltheme_post_type_archive_url( $radio_pt );
?>
<!-- wp:group {"align":"full","className":"cdl-carousel-section cdl-radio-carousel","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"backgroundColor":"section-paper","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull cdl-carousel-section cdl-radio-carousel has-section-paper-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide cdl-latest-carousel__header" style="margin-bottom:var(--wp--preset--spacing--60)">
		...
		<h2 class="wp-block-heading has-gray-text-color has-text-color has-serif-font-family has-x-large-font-size" style="font-weight:700;line-height:1.2"><?php esc_html_e( 'Rádio Companhia', 'cdltheme' ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group cdl-latest-carousel__controls">
			...
			<div class="wp-block-group cdl-latest-carousel__actions">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button cdl-carousel__cta is-style-outline"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( $radio_archive ); ?>"><?php esc_html_e( 'Ver todos', 'cdltheme' ); ?></a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
	...
	<div class="wp-block-group alignwide cdl-carousel" data-cdl-carousel data-cdl-visible="3" data-cdl-total="6">
		...
		<div class="wp-block-group cdl-carousel__viewport">
			<!-- wp:query {"queryId":13,"query":{"perPage":6,"pages":0,"offset":0,"postType":"<?php echo esc_attr( $radio_pt ); ?>","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"align":"wide","className":"cdl-carousel__query cdl-query-company-radio","layout":{"type":"default"}} -->
			<div class="wp-block-query alignwide cdl-carousel__query cdl-query-company-radio">
			<!-- wp:post-template {"className":"cdl-carousel__track"} -->
				<!-- wp:group {"className":"cdl-carousel__slide cdl-carousel__slide--radio","layout":{"type":"default"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} -->
				<div class="wp-block-group cdl-carousel__slide cdl-carousel__slide--radio">
					...
					<!-- wp:post-excerpt {"className":"cdl-carousel__excerpt","fontSize":"small","moreText":"","excerptLength":28} /-->
				</div>
				<!-- /wp:group -->
			<!-- /wp:post-template -->
				...
				<!-- wp:query-no-results -->
				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'Ainda não há itens de rádio publicados. Crie entradas em «Rádio Companhia» no painel.', 'cdltheme' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- /wp:query-no-results -->
			</div>
			<!-- /wp:query -->
