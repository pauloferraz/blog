/**
 * Carrossel "Mais lidos": 9 posts; 3 visíveis no desktop e 1 no mobile (≤781px).
 * Avança uma "página" (largura do viewport) de cada vez, por setas ou swipe.
 */
(function () {
	'use strict';
	...
	function initCarousel(root) {
		...
		var track = qs(root, '.cdl-carousel__track');
